...
public class CensoNptViewModel : ICensoRegistroEditable
{
    ...
    [Required(ErrorMessage = "La fecha de ingreso a programa es obligatoria.")]
    [DataType(DataType.Date)]
    [Display(Name = "Fecha de ingreso a programa")]
    public DateTime FechaIngresoPrograma { get; set; } = DateTime.Today;

    [Required(ErrorMessage = "Selecciona el tipo de ID.")]
    [StringLength(3)]
    ...
    [Display(Name = "Llamada de bienvenida")]
    ...
    [Display(Name = "Días de tratamiento")]
    public int? DiasTratamiento { get; set; }

    [DataType(DataType.Time)]
    [Display(Name = "Hora de conexión")]
    public TimeSpan? HoraConexion { get; set; }

    [DataType(DataType.Time)]
    [Display(Name = "Hora desconexión")]
    public TimeSpan? HoraDesconexion { get; set; }

    [Display(Name = "Cargue laboratorios")]
    public string? CargueLaboratorios { get; set; }

    [Display(Name = "Cargue de glucometría")]
    public string? CargueGlucometria { get; set; }

    [Display(Name = "Cargue de servicios complementarios")]
    public string? CargueServiciosComplementarios { get; set; }

    [Display(Name = "Cargue de seguimiento médico")]
    public string? CargueSeguimientoMedico { get; set; }

    [Display(Name = "Equipo en comodato")]
    public string? EquipoComodato { get; set; }

    [StringLength(200, ErrorMessage = "La descripción del equipo no puede superar 200 caracteres.")]
    [Display(Name = "Descripción del equipo (Bomba)")]
    ...
    public IReadOnlyList<CensoNptRecord> UltimosRegistros { get; set; } = [];
}
