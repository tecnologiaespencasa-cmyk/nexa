...
public partial class CensoController
{
    ...
    private static readonly IReadOnlyDictionary<string, string> CronicoDiagnosticoCatalog = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["B209"] = "ENFERMEDAD POR VIH RESULTANTE EN INFECCIONES BACTERIANAS O PARASITARIAS NO ESPECIFICADAS",
        ["C819"] = "ENFERMEDAD DE HODGKIN, NO ESPECIFICADA",
        ["J449"] = "ENFERMEDAD PULMONAR OBSTRUCTIVA CRÓNICA, NO ESPECIFICADA",
        ["E135"] = "DIABETES MELLITUS, NO ESPECIFICADA CON COMPLICACIONES CIRCULATORIAS PERIFÉRICAS",
        ["R521"] = "DOLOR CRÓNICO INTRATABLE",
        ...
        ["G912"] = "HIDROCEFALO DE PRESIÓN NORMAL",
        ...
        ["C023"] = "TUMOR MALIGNOS DE LOS DOS TERCIOS ANTERIOR DE LA LENGUA, PARTE NO ESPECIFICADA",
        ["C349"] = "TUMOR MALIGNOS DE LOS BRONQUIOS O DEL PULMÓN, PARTE NO ESPECIFICADA",
        ...
        ["C64X"] = "TUMOR MALIGNO DEL RIÑÓN, EXCEPTO LA PELVIS RENAL",
        ["C169"] = "TUMOR MALIGNO DEL ESTÓMAGO, PARTE NO ESPECIFICADA",
        ["C260"] = "TUMOR MALIGNO DEL INTESTINO DELGADO, PARTE NO ESPECIFICADA",
        ["C20X"] = "TUMOR MALIGNO DEL RECTO",
        ["C609"] = "TUMOR MALIGNO DEL PENE PARTE NO ESPECIFICADA",
        ["C73X"] = "TUMOR MALIGNO DE LA GLÁNDULA TIROIDES",
        ["C795"] = "TUMOR MALIGNO SECUNDARIO DE LOS HUESOS Y DE LA MÉDULA OSEA",
        ["I830"] = "VENAS VARICOSAS DE LOS MIEMBROS INFERIORES CON ÚLCERA",
        ["G809"] = "PARÁLISIS CEREBRAL INFANTIL, SIN OTRA ESPECIFICACIÓN",
        ["F729"] = "RETRASO MENTAL GRAVE: DETERIORO DEL COMPORTAMIENTO DE GRADO NO ESPECIFICADO",
        ["G619"] = "POLINEUROPATÍA INFLAMATORIA, NO ESPECIFICADA",
        ["K746"] = "OTRAS CIRROSIS DEL HÍGADO Y LAS NO ESPECIFICADAS",
        ["M866"] = "OTRAS OSTEOMIELITIS CRÓNICA",
        ["M159"] = "POLIARTROSIS, NO ESPECIFICADA",
        ["T940"] = "SECUELAS DE TRAUMATISMOS QUE AFECTAN MÚLTIPLES REGIONES DEL CUERPO",
        ["G09X"] = "SECUELAS DE ENFERMEDAD INFLAMATORIA DEL SNC",
        ["T921"] = "SECUELAS DE FRACTURA DEL BRAZO",
        ["T911"] = "SECUELAS DE FRACTURA DE COLUMNA VERTEBRAL",
        ["T931"] = "SECUELAS DE FRACTURA DE FÉMUR",
        ["T922"] = "SECUELAS DE FRACTURA DE LA MUÑECA Y DE LA MANO",
        ["I693"] = "SECUELAS DE INFARTO CEREBRAL",
        ["I692"] = "SECUELAS DE HEMORRAGIAS INTRACRANEALES NO TRAUMÁTICAS",
        ["I690"] = "SECUELAS DE HEMORRAGIA SUBARACNOIDEA",
        ["I691"] = "SECUELAS DE HEMORRAGIA INTRAENCEFÁLICA",
        ["T905"] = "SECUELAS DE TRAUMATISMO INTRACRANEAL",
        ["T913"] = "SECUELAS DE TRAUMATISMO DE LA MÉDULA ESPINAL",
        ["T932"] = "SECUELAS DE OTRAS FRACTURAS DE MIEMBRO INFERIOR",
        ["U071"] = "COVID-19, IDENTIFICADO",
        ["R522"] = "OTRO DOLOR CRÓNICO",
    };
